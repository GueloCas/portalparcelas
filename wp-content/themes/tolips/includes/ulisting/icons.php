...
add_filter('ulisting_icons', function($icons){
	$icons['tolips-icons'] = array (
		'name' => esc_html__( 'Icons of Theme', 'tolips'),
		'icons' =>array (
			array ( 'name' => 'health', 'class' => 'flaticon-health' ),
			array ( 'name' => 'cutlery', 'class' => 'flaticon-cutlery' ),
			array ( 'name' => 'cocktail', 'class' => 'flaticon-cocktail' ),
			array ( 'name' => 'skincare', 'class' => 'flaticon-skincare' ),
			array ( 'name' => 'shop', 'class' => 'flaticon-shop' ),
			array ( 'name' => 'car', 'class' => 'flaticon-car' ),
			array ( 'name' => 'selection', 'class' => 'flaticon-selection' ),
			array ( 'name' => 'delete', 'class' => 'flaticon-delete' ),
			array ( 'name' => 'exploration', 'class' => 'flaticon-exploration' ),
			array ( 'name' => 'calling', 'class' => 'flaticon-calling' ),
			array ( 'name' => 'magnifying-glass', 'class' => 'flaticon-magnifying-glass' ),
			array ( 'name' => 'heart', 'class' => 'flaticon-heart' ),
			array ( 'name' => 'directory', 'class' => 'flaticon-directory' ),
			array ( 'name' => 'clipboard', 'class' => 'flaticon-clipboard' ),
			array ( 'name' => 'discount', 'class' => 'flaticon-discount' ),
			array ( 'name' => 'scissors', 'class' => 'flaticon-scissors' ),
			array ( 'name' => 'quote', 'class' => 'flaticon-quote' ),
			array ( 'name' => 'focus', 'class' => 'flaticon-focus' ),
			array ( 'name' => 'left-arrow', 'class' => 'flaticon-left-arrow' ),
			array ( 'name' => 'right-arrow-1', 'class' => 'flaticon-right-arrow-1' ),
			array ( 'name' => 'wifi', 'class' => 'flaticon-wifi' ),
			array ( 'name' => 'check', 'class' => 'flaticon-check' ),
			array ( 'name' => 'comment', 'class' => 'flaticon-comment' ),
			array ( 'name' => 'star-1', 'class' => 'flaticon-star-1' ),
			array ( 'name' => 'star', 'class' => 'flaticon-star' ),
			array ( 'name' => 'star-2', 'class' => 'flaticon-star-2' ),
			array ( 'name' => 'email', 'class' => 'flaticon-email' ),
			array ( 'name' => 'phone', 'class' => 'flaticon-phone' ),
			array ( 'name' => 'plus', 'class' => 'flaticon-plus' ),
			array ( 'name' => 'phone-call', 'class' => 'flaticon-phone-call' ),
			array ( 'name' => 'message', 'class' => 'flaticon-message' ),
			array ( 'name' => 'shopping-cart', 'class' => 'flaticon-shopping-cart' ),
			array ( 'name' => 'building', 'class' => 'flaticon-building' ),
			array ( 'name' => 'town', 'class' => 'flaticon-town' ),
			array ( 'name' => 'assets', 'class' => 'flaticon-assets' ),
			array ( 'name' => 'rent', 'class' => 'flaticon-rent' ),
			array ( 'name' => 'bed', 'class' => 'flaticon-bed' ),
			array ( 'name' => 'shower-1', 'class' => 'flaticon-shower-1' ),
			array ( 'name' => 'square-measument', 'class' => 'flaticon-square-measument' ),
			array ( 'name' => 'home', 'class' => 'flaticon-home' ),
			array ( 'name' => 'nature', 'class' => 'flaticon-nature' ),
			array ( 'name' => 'armchair', 'class' => 'flaticon-armchair' ),
			array ( 'name' => 'condominium', 'class' => 'flaticon-condominium' ),
			array ( 'name' => 'bungalow', 'class' => 'flaticon-bungalow' ),
			array ( 'name' => 'modern-house', 'class' => 'flaticon-modern-house' ),
			array ( 'name' => 'buildings', 'class' => 'flaticon-buildings' ),
			array ( 'name' => 'confirmation', 'class' => 'flaticon-confirmation' ),
			array ( 'name' => 'home-1', 'class' => 'flaticon-home-1' ),
			array ( 'name' => 'cityscape', 'class' => 'flaticon-cityscape' ),
			array ( 'name' => 'agent', 'class' => 'flaticon-agent' ),
			array ( 'name' => 'checked', 'class' => 'flaticon-checked' ),
			array ( 'name' => 'extractor-hood', 'class' => 'flaticon-extractor-hood' ),
			array ( 'name' => 'fireplace', 'class' => 'flaticon-fireplace' ),
			array ( 'name' => 'window', 'class' => 'flaticon-window' ),
			array ( 'name' => 'pet-house', 'class' => 'flaticon-pet-house' ),
			array ( 'name' => 'desk', 'class' => 'flaticon-desk' ),
			array ( 'name' => 'tiles', 'class' => 'flaticon-tiles' ),
			array ( 'name' => 'staircase', 'class' => 'flaticon-staircase' ),
			array ( 'name' => 'bath', 'class' => 'flaticon-bath' ),
			array ( 'name' => 'shower', 'class' => 'flaticon-shower' )
	  	),
	);
	return $icons;
});
...
add_filter('ulisting_icons', function($icons){
	...
	$icons['line-awesome-icons'] = array (
		'name' => esc_html__( 'Line Awesome Icons', 'tolips'),
		'icons' =>array ()
	);
	$find = array('lab la-', 'lar la-', 'las la-', 'la la-');
	foreach ($lineawesome_icons as $icon) {
		$icons['line-awesome-icons']['icons'][] = array( 'name' => str_replace($find, '', $icon), 'class' => $icon );
	}
	return $icons;
});