...
$types = json_encode(
    [
        ['id' => 'hours', 'title' => esc_html__('Hours', 'tolips')],
        ['id' => 'weekly', 'title' => esc_html__('Weekly', 'tolips')],
        ['id' => 'monthly', 'title' => esc_html__('Monthly', 'tolips')],
    ]
);
...
$user = [
    "checked" => true,
    "label" => esc_html__('Clicked', 'tolips'),
