...
<div id="user-plan-detail">
	...
	<div class="dashboard-content-inner">
		...
		<div class="stm-row">
			<div class="stm-col-xl-3 stm-col-lg-3 stm-col-12"><label><?php echo esc_html__('Estado', 'tolips') ?>: </label></div>
		...
		<?php if($user_plan->payment_type !== \uListing\Lib\PricingPlan\Classes\StmPricingPlans::PRICING_PLANS_PAYMENT_TYPE_SUBSCRIPTION): ?>
			 <div class="stm-row">
				  <div class="stm-col-xl-3 stm-col-lg-3 stm-col-12"><label><?php echo esc_html__('Tipo', 'tolips') ?>: </label></div>
		...
		<?php endif;?>
		<div class="stm-row">
			<div class="stm-col-xl-3 stm-col-lg-3 stm-col-12"><label><?php echo esc_html__('Tipo de pago', 'tolips') ?>: </label></div>
		...
		-->
		<div class="stm-row">
			<div class="stm-col-3"><label><?php echo esc_html('Limite de imágenes', 'tolips');?> : </label></div>
			<div class="stm-col-4"><?php echo get_post_meta($plan->ID, 'listing_image_limit', true)?></div>
		</div>
		<?php if($user_plan->payment_type == \uListing\Lib\PricingPlan\Classes\StmPricingPlans::PRICING_PLANS_PAYMENT_TYPE_SUBSCRIPTION): ?>
			<div class="stm-row">
				<div class="stm-col-xl-3 stm-col-lg-3 stm-col-12"><label><?php echo esc_html__('Fecha de expiración', 'tolips') ?>: </label></div>
		...
		<div class="stm-row">
			<div class="stm-col-xl-3 stm-col-lg-3 stm-col-12"><label><?php echo esc_html__('Fecha de creación', 'tolips') ?>: </label></div>
			<div class="stm-col-xl-9 stm-col-lg-9 stm-col-12">
		...
		<?php if($user_plan->payment_type == \uListing\Lib\PricingPlan\Classes\StmPricingPlans::PRICING_PLANS_PAYMENT_TYPE_SUBSCRIPTION): ?>
			<?php if( (
				...
				<div class="panel-custom p-t-30 p-b-30">
					...
					<button class="btn btn-danger" v-if="!loading" @click="user_plan_cancel"><?php echo esc_html__("Cancelar", "tolips")?></button>
				</div>
