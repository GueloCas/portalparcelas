...
<div class="ulisting-form-gruop">
	...
	<date-picker placeholder="<?php echo esc_attr__('Select date', 'tolips')?>" clearable="false"  confirm v-model="attributes.<?php echo esc_attr($attribute->name)?>.value" input-class="form-control" width="100%" class="stm-date-picker"  format="DD/MM/YYYY" lang="<?php echo esc_attr($lang)?>"></date-picker>
