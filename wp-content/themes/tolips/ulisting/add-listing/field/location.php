        ...
        <stm-location-component inline-template v-model="attributes.<?php echo esc_attr($attribute->name) ?>.value">
            <div>
                <div class="stm-row">
                    ...
                    <div class="stm-col">
                        <div class="ulisting-form-gruop">
                            <input class="form-control" type="text" placeholder="<?php echo esc_attr('Postal code', 'tolips')?>"
                    ...
                    <div class="stm-col">
                        <div class="ulisting-form-gruop">
                            <input type="text" id="uListing_listing_search" class="form-control"
                                   placeholder="<?php echo esc_attr('Enter a location', 'tolips') ?>" autocomplete="off">
                        </div>
                    </div>
                    <div class="stm-col">
                        <div class="ulisting-form-gruop">
