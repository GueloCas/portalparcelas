...
class Validation
{
		...
		foreach ($this->errors as $e)
		{
			...
			if (isset($messages[$e['rule']])) {
				...
				if (!isset($resp[$e['field']])) {
					...
					$message = str_replace('{param}', $param, str_replace('{field}', esc_html__($field, 'ulisting'), $messages[$e['rule']]));
	...
	public function get_message_array() {
		return array(
			...
			'validate_max_len'                  => esc_html__('Este campo debe contener máximo {param} caracteres', "ulisting"),
			'validate_min_len'                  => esc_html__('Este campo debe contener al menos {param} caracteres', "ulisting"),
			...
			'validate_alpha_numeric_space'      => esc_html__('The {field} field may only contain letters, numbers and spaces', "ulisting"),
			'validate_alpha_dash'               => esc_html__('The {field} field may only contain letters and dashes', "ulisting"),
			'validate_alpha_space'              => esc_html__('The {field} field may only contain letters and spaces', "ulisting"),
			'validate_numeric'                  => esc_html__('The {field} field must be a number', "ulisting"),
			'validate_integer'                  => esc_html__('The {field} field must be a number without a decimal', "ulisting"),
			'validate_boolean'                  => esc_html__('The {field} field has to be either true or false', "ulisting"),
			'validate_float'                    => esc_html__('The {field} field must be a number with a decimal point (float)', "ulisting"),
			'validate_valid_url'                => esc_html__('The {field} field has to be a URL', "ulisting"),
			'validate_url_exists'               => esc_html__('The {field} URL does not exist', "ulisting"),
			'validate_valid_ip'                 => esc_html__('The {field} field needs to be a valid IP address', "ulisting"),
			'validate_valid_ipv4'               => esc_html__('The {field} field needs to contain a valid IPv4 address', "ulisting"),
			'validate_valid_ipv6'               => esc_html__('The {field} field needs to contain a valid IPv6 address', "ulisting"),
			'validate_guidv4'                   => esc_html__('The {field} field needs to contain a valid GUID', "ulisting"),
			'validate_valid_cc'                 => esc_html__('The {field} is not a valid credit card number', "ulisting"),
			'validate_valid_name'               => esc_html__('The {field} should be a full name', "ulisting"),
			'validate_contains'                 => esc_html__('The {field} can only be one of the following: {param}', "ulisting"),
			'validate_contains_list'            => esc_html__('The {field} is not a valid option', "ulisting"),
			'validate_doesnt_contain_list'      => esc_html__('The {field} field contains a value that is not accepted', "ulisting"),
			'validate_street_address'           => esc_html__('The {field} field needs to be a valid street address', "ulisting"),
			'validate_date'                     => esc_html__('The {field} must be a valid date', "ulisting"),
			'validate_min_numeric'              => esc_html__('The {field} field needs to be a numeric value, equal to, or higher than {param}', "ulisting"),
			'validate_max_numeric'              => esc_html__('The {field} field needs to be a numeric value, equal to, or lower than {param}', "ulisting"),
			'validate_min_age'                  => esc_html__('The {field} field needs to have an age greater than or equal to {param}', "ulisting"),
			'validate_invalid'                  => esc_html__('The {field} field is invalid', "ulisting"),
			'validate_starts'                   => esc_html__('The {field} field needs to start with {param}', "ulisting"),
			'validate_extension'                => esc_html__('{field} solo acepta los formatos: {param}', "ulisting"),
			...
			'validate_valid_json_string'        => esc_html__('The {field} field needs to contain a valid JSON format string', "ulisting"),
			'validate_valid_array_size_greater' => esc_html__('The {field} fields needs to be an array with a size, equal to, or higher than {param}', "ulisting"),
			'validate_valid_array_size_lesser'  => esc_html__('The {field} fields needs to be an array with a size, equal to, or lower than {param}', "ulisting"),
			'validate_valid_array_size_equal'   => esc_html__('The {field} fields needs to be an array with a size equal to {param}', "ulisting"),
			'validate_valid_persian_name'       => esc_html__('The {field} should be a valid Persian/Dari or Arabic name', "ulisting"),
			'validate_valid_eng_per_pas_name'   => esc_html__('The {field} should be a valid English, Persian/Dari/Pashtu or Arabic name', "ulisting"),
			'validate_valid_persian_digit'      => esc_html__('The {field} should be a valid digit in Persian/Dari or Arabic format', "ulisting"),
			'validate_valid_persian_text'       => esc_html__('The {field} should be a valid text in Persian/Dari or Arabic format', "ulisting"),
			'validate_valid_pashtu_text'        => esc_html__('The {field} should be a valid text in Pashtu format', "ulisting"),
			'validate_valid_twitter'            => esc_html__('The {field} is not a valid twitter handle', "ulisting"),
		);
	}
