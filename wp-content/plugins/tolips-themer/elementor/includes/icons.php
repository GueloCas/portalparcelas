<?php
   add_filter( 'elementor/icons_manager/additional_tabs', 'tolips_custom_icons_filters' , 9999999, 1 );
   function tolips_custom_icons_filters( $tabs = array() ) {
      $newicons = [];
      ...
      $newicons[ 'gva_custom_icon' ] = [
         ...
         'ver'           => '1.2',
         'fetchJson'     => GAVIAS_TOLIPS_PLUGIN_URL . 'elementor/assets/icons.json',
      ];
      return array_merge( $tabs, $newicons );
   }

   add_action( 'wp_print_footer_scripts', 'tolips_insert_icons_footer_css'  );
   function tolips_insert_icons_footer_css() {
      echo '<link rel="stylesheet" type="text/css" href="' . GAVIAS_TOLIPS_PLUGIN_URL . 'assets/icons/flaticon.css">';
   }

   add_filter( 'elementor/icons_manager/additional_tabs', 'tolips_lineawesome_icon' );  
   function tolips_lineawesome_icon( $icons = array() ) {
       ...
       $icons['tolips-lineawesome-icon'] = array(
           'name'          => 'tolips-lineawesome-icon',
           'label'         => esc_html__( 'Line Awesome', 'tolips-themer' ),
           'labelIcon'     => 'fas fa-user',
           'prefix'        => '',
           'displayPrefix' => '',
           'icons'         => $lineawesome_icons,
            'url'          => GAVIAS_TOLIPS_PLUGIN_URL . 'elementor/assets/libs/line-awesome/css/line-awesome.min.css',
           'ver'           => '1.0',
       );
